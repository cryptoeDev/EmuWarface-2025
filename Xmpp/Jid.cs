...
namespace EmuWarface.Xmpp
{
    public sealed class Jid
    {
        ...
        public Jid(string jid, String data = null)
        {
            ...
            if (data != null)
                GameClient = XElement.Parse(data).Attribute("from").Value;
        ...
        public Jid(string domain, string node, string resource = null, String data = null)
        {
