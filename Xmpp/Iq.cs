...
namespace EmuWarface.Xmpp
{
    public class Iq : Stanza
    {
        ...
        public void Compress()
        {
            ...
            byte[] rawData = Encoding.UTF8.GetBytes(xmlString);
            byte[] compressedData = ZlibStream.CompressBuffer(Encoding.UTF8.GetBytes(xmlString));
            string base64Data = Convert.ToBase64String(compressedData);

            data.Attr("query_name", Query.Name)
                .Attr("compressedData", base64Data)
